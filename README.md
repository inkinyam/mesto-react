...
14. Фреймфорк React (классовые и функциональные компоненты, хуки)
...
На данный момент проект ссылается на реализованный без React проект

## Планируемые доработки
1. Переделка проекта с использованием React
